...
- Người mới học C muốn tìm ví dụ **thực tế, code rõ ràng, dễ tham chiếu**.
- Giáo viên hoặc mentor muốn có **tài liệu để minh họa bài giảng**.
...
- **Bạn bè / cộng đồng:** tham khảo, đóng góp ý tưởng hoặc cải thiện code.
- **Người học C:** muốn có dự thực hành theo chuẩn.
...
```bash
git clone https://github.com/hien131106/IOT-CPRO-K26.2-exam.git
cd IOT-CPRO-K26.2-exam
```
